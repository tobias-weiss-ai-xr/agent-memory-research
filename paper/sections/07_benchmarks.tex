...
The rapid growth of agent memory research has been accompanied by a corresponding proliferation of evaluation benchmarks. Our dataset includes 18 benchmark-focused papers proposing 14 distinct evaluation protocols. We survey the major benchmarks, identify their coverage gaps, and propose design requirements for a unified evaluation framework.
...
We release a preliminary specification for such a benchmark in the project repository and invite community contributions to its development.
