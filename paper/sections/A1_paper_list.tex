...
Table~\ref{tab:paper_list} lists all 220 papers in our dataset with their taxonomy classifications. The full dataset is available in \texttt{papers.yaml} in the repository.
