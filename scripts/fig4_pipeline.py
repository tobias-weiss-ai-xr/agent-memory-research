...
boxes = [
    ...
    (0.22, 0.55, 0.14, 0.30, "validate_papers.py", "Validation &\nNormalization", "#E3F2FD"),
    (0.42, 0.55, 0.14, 0.30, "generate_readme.py", "README + JSON\nGeneration", "#FFF3E0"),
    ...
    (0.42, 0.10, 0.14, 0.25, "fetch_new_papers.py", "arXiv New\nPaper Crawler", "#FBE9E7"),
...
arrows = [
    (0.16, 0.70, 0.22, 0.70), (0.36, 0.70, 0.42, 0.70), (0.56, 0.70, 0.62, 0.70),
]
...
ax.annotate("", xy=(0.09, 0.55), xytext=(0.69, 0.40),
            arrowprops=dict(arrowstyle="->", color="green", lw=1, linestyle="dashed",
...
plt.tight_layout()
out = base / "paper/figures/fig4_pipeline.pdf"
