...
DEPRECATED: Use generate_readme.py instead (requires PyYAML, which is
listed in requirements.txt). Kept for environments where PyYAML is
unavailable. Will be removed in a future cleanup.
"""
